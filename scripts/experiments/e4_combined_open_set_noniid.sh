...
for alpha in "0.1" "10.0"; do
  invoke_hydra_run "experiment=exp4" "+method=fmrl_la" "seed=42" "dataset.preprocessing.alpha=$alpha"
  invoke_hydra_run "experiment=exp4" "+method=fmrl_la" "seed=42" "dataset.preprocessing.alpha=$alpha" "open_set.evt.enabled=false" "experiment.method=ClosedSet_No_EVT" "tracking.run_id=e4_no_evt_alpha${alpha}_seed42"

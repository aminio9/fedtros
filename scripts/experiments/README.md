...
- `e1_closed_set.sh` through `e8_multi_dataset_open_set_noniid.sh`: experiment command files.
...
- `e8_multi_dataset_open_set_noniid.sh`: external benchmark validation scaffold for B-TAT, ToN-IoT, and CIC-IDS2017; it skips datasets until their final mappings are supplied.

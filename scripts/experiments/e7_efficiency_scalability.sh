...
for rounds in 50 100 200; do
  for clients in 3 10 20 50 100; do
    invoke_hydra_run "experiment=exp7" "+method=fmrl_la" "seed=42" "federated.num_clients=$clients" "federated.num_rounds=$rounds" "tracking.run_id=e7_fmrl_la_clients${clients}_rounds${rounds}_seed42"

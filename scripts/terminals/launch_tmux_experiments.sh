...
if [[ ! -f "${ROOT_DIR}/pyproject.toml" && -f "${SCRIPT_DIR}/../../pyproject.toml" ]]; then
...
SESSIONS=(
    ...
    "t5_datasets_mc:scripts/terminals/run_terminal_5_datasets_mc.sh:logs/terminal_5_datasets_mc.log:Datasets, Scale, LOAO, Sensitivity (E5-E8, S1)"
    "t6_baselines_e1_e3:scripts/terminals/run_terminal_6_baselines_e1_e3.sh:logs/terminal_6_baselines_e1_e3.log:Baselines (E1, E2, E3)"
    "t7_baselines_e4:scripts/terminals/run_terminal_7_baselines_e4.sh:logs/terminal_7_baselines_e4.log:Baselines E4 (15 runs = 5 methods x 3 alphas)"
    "t8_baselines_e5_e7:scripts/terminals/run_terminal_8_baselines_e5_e7.sh:logs/terminal_8_baselines_e5_e7.log:Baselines E5 & E7 (Datasets & Efficiency)"
)

# Make all terminal scripts executable
chmod +x "${ROOT_DIR}"/scripts/terminals/run_terminal_*.sh || true

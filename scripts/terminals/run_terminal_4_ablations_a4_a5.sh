...
echo "📌 [1/2] Running A4-PR (Multi-Center Shrinkage vs Prototype-Rank at alpha 0.5)..."
...
echo "📌 [2/2] Running A5-FEATURE (Intermediate Layer Tapping & ConFID Ensemble at alpha 0.5)..."

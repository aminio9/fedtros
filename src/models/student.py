...
class StudentIDSModel(nn.Module):
    """Compact globally shared classifier for DKD-FedOS.

    The CVAE-DQN teacher remains local/personalized. This student is the only
    neural model family transmitted to the server. Open-set recognition is now
    performed from the student's learned feature space by Feature-EVT.
    """

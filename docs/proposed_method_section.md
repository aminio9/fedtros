...
The default full-action bandit target is
...
در هدف full-action bandit داریم:

\[
t_j =
\begin{cases}
r_{+}, & j=a^\ast,\\
r_{-}, & j\neq a^\ast \text{ و کلاس } j \text{ در کلاینت حاضر باشد},\\
\text{masked}, & j \text{ در کلاینت غایب باشد}.
\end{cases}
\]

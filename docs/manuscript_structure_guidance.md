...
Paragraph 4 should summarize the proposed contribution in one compact paragraph: CVAE-DQN local learning, generator reconstruction, FMRL-LA utility-aware aggregation, and EVT calibration.
...
Paragraph 3 should define the federated objective and show the FedAvg/FedProx optimization equations.
...
Paragraph 4 should define baselines: centralized, local-only, FedAvg, FedProx, and FMRL-LA.
...
Paragraph 1 should explain the purpose of ablations: isolating EVT, generator reconstruction, FMRL-LA, FedAvg, FedProx, and client selection.

Paragraph 2 should report module-removal results.

Paragraph 3 should report sensitivity to Dirichlet alpha, EVT tail fraction, utility threshold, random seed, and client count.
...
Paragraph 3 should discuss FMRL-LA overhead and additional server-side state.
...
Paragraph 3 should state future work: adaptive unknown classes, dataset-specific calibration refinement, and communication-efficient FMRL-LA variants.

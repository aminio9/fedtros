...
| 1. IID baselines | E1-IID-CS, E2-IID-OSR | 10 clients, 100 rounds, seeds 17/42/73/101/137 | pending | all manifests completed and canonical |
...
| 6. Component evidence | A1-TEACHER, A2-ANCHOR, A3-TRANSFER, A4-PR, A5-FEATURE, S1-SENSITIVITY | fixed protocol, no unknown leakage; five seeds for final tables | pending | ablation deltas and sensitivity intervals |
...
The current repository intentionally fails this gate because the available runs are smoke/development artifacts (two clients, two rounds, seed 42) and do not constitute paper evidence.